<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      ...
      <h3 class="nav-brand text-bold ml-2 mt-2"><span class="text-danger">PO</span> Management <span
          class="badge badge-light">System Management</span></h3>
    </li>
...
@endguest
    ...
    @endguest
      <ul class="dropdown-menu">
        @if(!in_array($userdefrule, ['QC FAB', 'QC FIN', 'QC INC', 'Fabrikasi', 'PPC']))
